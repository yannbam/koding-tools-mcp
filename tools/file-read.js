...
const handler = async (toolCall) => {
  ...
  try {
    ...
    // Use the existing renderResultForAssistant function to format the text nicely 
    const formattedOutput = `[Showing ${truncatedLines.length} of ${totalLines} lines total]\n\n` + 
